...
CMonsterMovementComponent::CMonsterMovementComponent()
{
}

CMonsterMovementComponent::CMonsterMovementComponent(const CMonsterMovementComponent& Com) :
	CMovementComponent(Com)
{
}

CMonsterMovementComponent::CMonsterMovementComponent(CMonsterMovementComponent&& Com) :
	CMovementComponent(Com)
{
}
...
bool CMonsterMovementComponent::Init()
{
...
bool CMonsterMovementComponent::Init(const char* FileName)
{
...
void CMonsterMovementComponent::PreUpdate(float DeltaTime)
{
...
void CMonsterMovementComponent::Update(float DeltaTime)
{
...
void CMonsterMovementComponent::PostUpdate(float DeltaTime)
{
...
CMonsterMovementComponent* CMonsterMovementComponent::Clone()
{
	return new CMonsterMovementComponent(*this);
}

void CMonsterMovementComponent::EndFrame()
{
	CMovementComponent::EndFrame();

}

bool CMonsterMovementComponent::MoveTileCheck()
{
...
bool CMonsterMovementComponent::MoveTileCheckX()
{
    // UpdateComponent의 현재위치를 가져온다.
    FVector3D ownerPos = mUpdateComponent->GetWorldPosition();
    ...
    // 현재위치에 MoveStep의 X값을 더하여 다음 프레임의 X좌표를 구한다.
    FVector2D  nextPos;
    nextPos.x = ownerPos.x + tempMoveStep.x;
    nextPos.y = ownerPos.y;
