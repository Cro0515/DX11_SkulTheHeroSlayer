...
struct FMeshSlot
{
    FIndexBuffer    IndexBuffer;            // 인덱스 버퍼
    CSharedPtr<class CMaterial> Material;   // 머티리얼
};
...
protected:
    FVertexBuffer       mVertexBuffer;          // 버텍스 버퍼
    std::vector<FMeshSlot*> mMeshSlot;          // 메쉬 슬롯 배열   
    D3D11_PRIMITIVE_TOPOLOGY    mPrimitive;     // 그릴 도형 타입
