...
void CProgressBar::SetGrayScale(EProgressBarImageType Type, bool flag)
{
    switch (Type)
    {
    case EProgressBarImageType::Back:
        mBackBrush.GrayScale = flag;
        break;
    case EProgressBarImageType::Fill:
        mFillBrush.GrayScale = flag;
        break;
    }
}
    ...
    const FVector2D& Size)
{
    ...
    mUICBuffer->SetGrayScale(Brush.GrayScale);
