...
bool CStartWidget::Init()
{
    ...
    CSharedPtr<CImage>  Logo = mScene->GetUIManager()->CreateWidget<CImage>("Logo");
    ...
    Back->SetTexture("StartBack", TEXT("Texture\\BackGround\\Title\\Title_BackGround.png"));
    Back->SetSize((float)RS.Width, (float)RS.Height);

    Logo->SetTexture("StartLogo", TEXT("Texture\\BackGround\\Title\\Title_Logo.png"));
    Logo->SetSize((float)RS.Width, (float)RS.Height);
    ...
    mEditorButton->SetSize(200.f, 80.f);
    ...
    mEditorButton->SetTexture(EButtonState::Normal, "EditorButton",
        TEXT("Texture\\Editor.png"));
    mEditorButton->SetTexture(EButtonState::Hovered, "EditorButton",
        TEXT("Texture\\Editor.png"));
    mEditorButton->SetTexture(EButtonState::Click, "EditorButton",
        TEXT("Texture\\Editor.png"));
